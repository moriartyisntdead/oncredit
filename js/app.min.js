...
$(function(){function r(){var e=$("#side-slider__money").slider("value"),i=$("#side-slider__term").slider("value"),r=e+e*(parseFloat(1.9)/100)*i,n=moment().add(i,"days").format("DD.MM.YYYY");$("#side-slider__sum").html(r+" грн"),$("#side-slider__return-date").html(n)}void 0!==$.fn.slider&&($("#calculator__slider").slider({orientation:"horizontal",range:"min",max:15e3,min:50,step:50,value:3e3,slide:function(e,i){$("#calculator__slider-value").html(i.value)}}),$("#side-slider__money").slider({orientation:"horizontal",range:"min",max:15e3,min:50,step:50,value:3e3,slide:function(e,i){$("#side-slider__money-value").html(i.value)},change:function(e,i){r()}}),$("#side-slider__term").slider({orientation:"horizontal",range:"min",max:30,min:1,step:1,value:15,create:function(e,i){r()},slide:function(e,i){$("#side-slider__term-value").html(i.value)},change:function(e,i){r()}})),$(".question__title").click(function(){$(this).toggleClass("question__title--active"),$(this).parent().siblings().children(".question__title").removeClass("question__title--active"),$(this).parent().children(".question__title").children(".switch").toggleClass("switch--active"),$(this).parent().siblings().children(".question__title").children(".switch").removeClass("switch--active")}),$(".navbar-toggler").click(function(){$(".banner__breadcrumbs").toggleClass("opened"),$(".banner__title").toggleClass("opened"),$(".calculator").toggleClass("opened"),$(".calculator-block__title").toggleClass("opened")}),jQuery("#tel").mask("380000000000"),jQuery("#inn").mask("0000000000"),$("#calculator").validate({rules:{tel:{required:!0,minlength:12,maxlength:12,digits:!0},email:{required:!0,email:!0},password:{required:!0,minlength:6},password_confirm:{required:!0,equalTo:"#password"},inn:{required:!0,minlength:10,maxlength:10,digits:!0},terms:"required"},messages:{tel:"Введите номер телефона",email:"Введите правильный email адрес",password:"Пароль должен содержать не мене 6 символов",password_confirm:"Пароли должны совпадать",inn:"Введите корректный ИНН",terms:"Нужно согласиться с условиями"},errorElement:"div",errorLabelContainer:".errorTxt",errorPlacement:function(e,i){var r=$(i).data("error");r?$(r).append(e):e.insertAfter(i)},submitHandler:function(e){}}),jQuery("#login_phone").mask("380000000000"),$("#login-form").validate({rules:{login_phone:{required:!0,minlength:12,maxlength:12,digits:!0},login_password:{required:!0,minlength:6}},messages:{login_phone:"Введите номер телефона",login_password:"Пароль должен содержать не мене 6 символов"},errorElement:"div",errorLabelContainer:".errorTxt",errorPlacement:function(e,i){var r=$(i).data("error");r?$(r).append(e):e.insertAfter(i)},submitHandler:function(e){}})});